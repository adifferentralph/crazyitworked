...
const permissionDefinitions = [
  ...
  ["assist_seller_inventory", "Create and import seller-owned listing drafts without financial access"],
...
const roleDefinitions: ReadonlyArray<{
  ...
  },
  {
    ...
    permissions: ["sellers.manage", "products.read", "assist_seller_inventory", "demand.read", "audit.read"],
  },
  {
    key: "SUPPORT_AGENT",
    name: "Support agent",
