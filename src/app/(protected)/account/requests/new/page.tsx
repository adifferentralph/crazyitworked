  ...
  return (
    <section className="min-h-screen bg-stone-50 py-8 sm:py-12">
      <div className="container-page max-w-4xl">
        ...
        <div className="mt-5 flex items-start gap-4 border-b border-stone-200 pb-7">
          ...
          <div>
            <h1 className="text-3xl font-semibold text-stone-950 sm:text-4xl">Request a part</h1>
            <p className="mt-2 max-w-2xl text-sm leading-6 text-stone-600">
              Tell us which part you need. Suppliers who sell that type of part can respond with a
              quote.
            </p>
          </div>
        </div>
        <div className="mt-7">
          <RequestPartForm categories={options.categories} savedVehicles={options.savedVehicles} />
        </div>
      </div>
    </section>
  );
